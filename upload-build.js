...
async function overwriteFile(branch) {
  const localFilePath = `./dist/bundle.js`; // Assuming the file is in the 'src' directory
  ...
  try {
    ...
    const bodyData = {};
    bodyData[`promotion-service`] = `https://res.cloudinary.com/${process.env.CL_NAME}/raw/upload/v${result.version}/${result.public_id}`
